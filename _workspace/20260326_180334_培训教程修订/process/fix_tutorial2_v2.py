...
# 第一章：从1.2弹性张量理论开始（第106行）到1.3结束（第329行之前）
new_content.append('## 第一章 弹性张量理论\n\n')
new_content.extend(lines[106:329])

# 第二章：Si案例（第330行到第533行）
new_content.append('\n')
new_content.extend(lines[329:534])

# 写入新文件
with open('教程2_弹性常数计算.md', 'w', encoding='utf-8') as f:
    f.writelines(new_content)

print("Tutorial 2 regenerated: lines 106-329 (theory) + 330-533 (Si case)")
